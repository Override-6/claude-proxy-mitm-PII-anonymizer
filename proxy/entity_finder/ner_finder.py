...
# DLP bias: prefer recall over precision. Short names (Li, Al, Bob, Ng) and
# low-confidence spans from the multilingual NER are exactly the cases where
# silent PII leaks happen, so we accept more false positives in exchange.
_MIN_ENTITY_CHARS = 2
